                    ...
                    <div class="header__container container">
                        ...
                        <nav class="header__menu-text">
                            ...
                            <ul class="header__menu-text-list">
                                <li class="header__menu-item header__logo-item">
                                    <a href="./index.html" class="header__menu-link header__logo-link" aria-label="Home">
                            ...
                            <ul class="header__menu-icons-list">
                                <li class="header__menu-icons-item">
                                    <div class="header__search-container">
                                        <button type="button" class="header__menu-icons-link header__search-toggle" id="search-toggle" aria-label="Search">
                                            <img src="./images/Search.svg" alt="Search" loading="lazy">
                                        </button>
                                        <div class="header__search-box" id="header-search-box" style="display: none;">
                                            <form class="header__search-form" id="header-search-form" onsubmit="handleHeaderSearch(event)">
                                                <input type="text" 
                                                ...
                                                <button type="button" class="header__search-close" id="header-search-close" aria-label="Close search">
                                                    ×
                                                </button>
                                            </form>
                                        </div>
                                        ...
                                        <div class="user-menu logout-button" id="user-menu" style="display: none;">
                                            <div class="user-info">
                                                ...
                                                <div class="user-dropdown">
                                                    ...
                                                    <a href="./my-orders.html" data-i18n="nav.orders">Orders</a>
